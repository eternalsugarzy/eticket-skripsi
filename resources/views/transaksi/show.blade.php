            ...
            <div class="card-body p-5">
                ...
                <div class="d-flex align-items-center mb-4 pb-3 border-bottom border-dark">
                    ...
                    <div style="width: 80px;" class="flex-shrink-0">
                        <img src="{{ asset('assets/images/logo2.png') }}" alt="Logo Kiri" style="width: 100%; height: auto; max-height: 70px; object-fit: contain;">
                    </div>
                    ...
                    <div style="width: 80px;" class="flex-shrink-0 text-end">
                        <img src="{{ asset('assets/images/logo1.png') }}" alt="Logo Kanan" style="width: 100%; height: auto; max-height: 70px; object-fit: contain;">
                    </div>
                ...
                <div class="row mb-3 small">
                    ...
                    <div class="col-6 text-end">
                        Kasir : {{ $transaksi->kasir->name ?? 'Admin' }}<br>
                ...
                <div class="table-responsive mb-3">
                    <table class="table table-sm table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $item->jenisTiket->nama_jenis ?? 'Tiket' }} <br> 
