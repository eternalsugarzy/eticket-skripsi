...
<div class="card card-modern">
    <div class="card-header-modern d-block">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" target="_blank"
                               href="{{ route('laporan.cetak-master', ['jenis' => 'objek_wisatas']) }}">
                                <i class="ti ti-list me-2"></i> Data Master Objek Wisata
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" target="_blank"
                               href="{{ route('laporan.cetak-objek', ['tgl_awal' => date('Y-m-01'), 'tgl_akhir' => date('Y-m-d')]) }}">
                                <i class="ti ti-map-pin me-2"></i> Statistik Kunjungan (Bulan Ini)
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" target="_blank"
                               href="{{ route('laporan.cetak-wishlist', ['tgl_awal' => date('Y-m-01'), 'tgl_akhir' => date('Y-m-d')]) }}">
                                <i class="ti ti-heart me-2"></i> Wishlist Terpopuler (Bulan Ini)
                            </a>
                        </li>
                    </ul>
                </div>
