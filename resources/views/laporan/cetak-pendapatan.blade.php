    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th width="25%" class="text-right">Total Pendapatan (IDR)</th>
            </tr>
        </thead>
        <tbody>
            @php $no = 1; $grand_total = 0; $total_transaksi = 0; @endphp
            
            @forelse ($laporan as $row)
            <tr>
                <td class="text-center">{{ $no++ }}</td>
                <td>{{ $row->nama_objek }}</td>
                <td class="text-center">{{ $row->jumlah_transaksi }} Kali</td>
        ...
        <tfoot>
            <tr class="total-row">
                ...
                <td class="text-center"><strong>{{ $total_transaksi }} Kali</strong></td>
