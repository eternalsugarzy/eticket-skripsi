...
<head>
    <meta charset="UTF-8">
    <title>Laporan Penjualan Tiket Offline</title>
    <style>
...
<body onload="window.print()">
    ...
    <h1>Laporan Penjualan Tiket Offline</h1>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th width="16%" class="text-right">Total Bayar</th>
            </tr>
        </thead>
        <tbody>
            ...
            @empty
            <tr><td colspan="7" class="text-center">Tidak ada transaksi offline pada periode ini.</td></tr>
            @endforelse
        </tbody>
        <tfoot>
            <tr class="total-row">
