...
<head>
    <meta charset="UTF-8">
    <title>Laporan Publikasi Berita dan Promosi Wisata</title>
    <style>
        ...
        .badge-berita { background: #ffe8cc; padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #92400e; }
        .badge-event  { background: #dbeafe; padding: 2px 6px; border-radius: 3px; font-size: 10px; color: #1e40af; }
...
<body onload="window.print()">
    ...
    <h1>Laporan Publikasi Berita dan Promosi Wisata</h1>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th width="9%">Jenis</th>
                <th>Judul</th>
                <th width="15%">Kategori/Objek Terkait</th>
                <th width="10%">Tanggal</th>
                <th width="10%">Status</th>
                <th width="13%">Diupload Oleh</th>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="8" class="text-center">Tidak ada publikasi berita/event pada periode ini.</td></tr>
            @endforelse
        </tbody>
        <tfoot>
            <tr class="total-row">
                <td colspan="7" class="text-right">TOTAL PUBLIKASI</td>
                <td class="text-center">{{ count($laporan) }}</td>
            </tr>
        </tfoot>
    </table>
